...
### [GitHub Packages ↗](https://github.com/orgs/teqbench/packages) Authentication
...
The repo `.npmrc` already configures the `@teqbench` scope to use [GitHub Packages ↗](https://github.com/orgs/teqbench/packages). The `~/.npmrc` auth line tells [npm ↗](https://www.npmjs.com) how to authenticate. CI handles this separately via [actions/setup-node ↗](https://github.com/actions/setup-node).
